    ...
    public function up(): void
    {
        Schema::create(config('comments.table_names.reactions', 'comment_reactions'), function (Blueprint $table) {
            ...
            if (config('comments.multi_tenancy.enabled', false)) {
                ...
                $column = match (config('comments.multi_tenancy.tenant_column_type', 'unsignedBigInteger')) {
            ...
            $table->unique(['comment_id', 'commenter_id', 'commenter_type', 'reaction'], 'comm_reactions_cid_cerid_certype_reaction_unique');
        });
    }
};
